...
/* Function randomNumber expects max and min (default 0) returns a random number between them */
/* PCODE Generate random number with math then (number *(max - min +1)) + min*/
